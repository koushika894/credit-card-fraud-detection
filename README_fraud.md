...
|-------|----------|-----------|--------|----------|---------|
| Logistic Regression (Baseline) | ~99.9% | High | Low | - | - |
| Random Forest (Baseline) | ~99.9% | High | Medium | - | - |
| Logistic Regression (SMOTE) | ~99.8% | Medium | High | - | - |
| Random Forest (SMOTE + Tuned) | ~99.9% | High | High | High | High |

**Best Model**: Tuned Random Forest with SMOTE achieves optimal balance between precision and recall.
